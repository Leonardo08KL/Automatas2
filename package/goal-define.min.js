(function () {
    ...
    let flowModel = {
        ...
        getNextState(ch, state) {
            ...
            if (
                state === DFA_STATE_CONST.S_RESET ||
                state === DFA_STATE_CONST.S_UNKNOWN
            ) {
            ...
            resultChange: {
                ...
                produceToken() {
                    if (lexer.DFA.result.matchs.length) {
                        ...
                        let token = { type: type, value: value };
    ...
    if (typeof ENUM_CONST !== "undefined") {
        if (!tool.isNodeEnvironment()) {
            window.ENUM_CONST = ENUM_CONST;
        } else {
            global.ENUM_CONST = ENUM_CONST;
        }
    }
    if (typeof CHARSET_CONST !== "undefined") {
        if (!tool.isNodeEnvironment()) {
            window.CHARSET_CONST = CHARSET_CONST;
        } else {
            global.CHARSET_CONST = CHARSET_CONST;
        }
    }
    if (typeof DFA_STATE_CONST !== "undefined") {
        if (!tool.isNodeEnvironment()) {
            window.DFA_STATE_CONST = DFA_STATE_CONST;
        } else {
            global.DFA_STATE_CONST = DFA_STATE_CONST;
        }
    }
    ...
    if (typeof flowModel !== "undefined") {
        if (!tool.isNodeEnvironment()) {
            window.flowModel = flowModel;
        } else {
            global.flowModel = flowModel;
        }
    }
})();
