!(function (e) {
    ...
    y.defineMode("sql", function (i, e) {
        var n = e.client || {},
            o = e.atoms || { false: !0, true: !0, null: !0 },
            s = e.builtin || v(x),
            l = e.keywords || v(a),
            c = e.operatorChars || /^[*+\-%<>!=&|~^\/]/,
            u = e.support || {},
            d = e.hooks || {},
            m = e.dateSQL || { date: !0, time: !0, timestamp: !0 },
            p = !1 !== e.backslashStringEscapes,
            g = e.brackets || /^[\{}\(\)\[\]]/,
            b = e.punctuation || /^[;.,:]/;
        function h(e, t) {
            var r = e.next();
            ...
            if (47 < r.charCodeAt(0) && r.charCodeAt(0) < 58)
                return (
                    ...
                    u.decimallessFloat && e.match(/^\.(?!\.)/),
                    "number"
                );
            if ("?" == r && (e.eatSpace() || e.eol() || e.eat(";")))
                return "variable-3";
            if ("'" == r || ('"' == r && u.doubleQuote))
                return (t.tokenize = f(r)), t.tokenize(e, t);
            if (
                ((u.nCharCast && ("n" == r || "N" == r)) ||
                    (u.charsetCast && "_" == r && e.match(/[a-z][a-z0-9]*/i))) &&
                ("'" == e.peek() || '"' == e.peek())
            )
                return "keyword";
            if (
                u.escapeConstant &&
                ("e" == r || "E" == r) &&
                ("'" == e.peek() || ('"' == e.peek() && u.doubleQuote))
            )
                return (
                    (t.tokenize = function (e, t) {
                        return (t.tokenize = f(e.next(), !0))(e, t);
                    }),
                    "keyword"
                );
            if (u.commentSlashSlash && "/" == r && e.eat("/"))
                return e.skipToEnd(), "comment";
            if (
                (u.commentHash && "#" == r) ||
                ("-" == r && e.eat("-") && (!u.commentSpaceRequired || e.eat(" ")))
            )
                return e.skipToEnd(), "comment";
            if ("/" == r && e.eat("*"))
                return (
            ...
            if ("." == r)
                return u.zerolessFloat && e.match(/^(?:\d+(?:e[+-]?\d+)?)/i)
                    ? "number"
                    : e.match(/^\.+/)
                        ? null
                        : u.ODBCdotTable && e.match(/^[\w\d_]+/)
                            ? "variable-2"
                            : void 0;
            if (c.test(r)) return e.eatWhile(c), "operator";
            if (g.test(r)) return "bracket";
            if (b.test(r)) return e.eatWhile(b), "punctuation";
            if (
                "{" == r &&
        ...
        return {
            ...
            indent: function (e, t) {
                var r = e.context;
                if (!r) return y.Pass;
                var a = t.charAt(0) == r.type;
                return r.align
                    ? r.col + (a ? 0 : 1)
                    : r.indent + (a ? 0 : i.indentUnit);
            },
            blockCommentStart: "/*",
            blockCommentEnd: "*/",
    ...
    y.defineMIME("text/x-sql", {
        ...
        keywords: v(a + "begin"),
        builtin: v(x),
        atoms: v("false true null unknown"),
        dateSQL: v("date time timestamp"),
        support: v("ODBCdotTable doubleQuote binaryNumber hexNumber"),
    }),
        y.defineMIME("text/x-mssql", {
            ...
            dateSQL: v("date datetimeoffset datetime2 smalldatetime datetime time"),
            hooks: { "@": t },
        }),
        ...
        y.defineMIME("text/x-sqlite", {
            ...
            atoms: v("null current_date current_time current_timestamp"),
            operatorChars: /^[*+\-%<>!=&|/~]/,
            dateSQL: v("date time timestamp datetime"),
            support: v("decimallessFloat zerolessFloat"),
            identifierQuote: '"',
            hooks: {
                "@": t,
                ":": t,
        ...
        y.defineMIME("text/x-cassandra", {
            ...
            atoms: v("false true infinity NaN"),
            operatorChars: /^[<>=]/,
            dateSQL: {},
            support: v("commentSlashSlash decimallessFloat"),
            hooks: {},
        }),
        y.defineMIME("text/x-plsql", {
            ...
            operatorChars: /^[*\/+\-%<>!=~]/,
            dateSQL: v("date time timestamp"),
            support: v("doubleQuote nCharCast zerolessFloat binaryNumber hexNumber"),
        }),
        ...
        y.defineMIME("text/x-sparksql", {
            ...
            atoms: v("false true null"),
            operatorChars: /^[*\/+\-%<>!=~&|^]/,
            dateSQL: v("date time timestamp"),
            support: v("ODBCdotTable doubleQuote zerolessFloat"),
        }),
        y.defineMIME("text/x-esper", {
            ...
            operatorChars: /^[*+\-%<>!=&|^\/#@?~]/,
            dateSQL: v("time"),
            support: v("decimallessFloat zerolessFloat binaryNumber hexNumber"),
        });
});
