!(function (e) {
    ...
    function P(e, t, n, r) {
        ...
        return (
            ...
            (e.context = new D(o, t, n, r, null, e.context))
        );
    }
    function E(e) {
    ...
    L.defineMode("clike", function (e, l) {
        var i,
            s,
            c = e.indentUnit,
            ...
            a = !1 !== l.indentStatements,
            t = !1 !== l.indentSwitch,
            x = l.namespaceSeparator,
            v = l.isPunctuationChar || /[\[\]{}\(\),;\:\.]/,
            w = l.numberStart || /[\d\.]/,
            _ =
                l.number ||
        ...
        function I(e, t) {
                    ...
                    (t.tokenize =
                        ((a = n),
                            function (e, t) {
                                ...
                                return (!o && (r || b)) || (t.tokenize = null), "string";
                            })),
                    t.tokenize(e, t)
                );
            if (v.test(n)) return (i = n), null;
            if (w.test(n)) {
            ...
            if (S.test(n)) {
                for (; !e.match(/^\/[\/*]/, !1) && e.eat(S););
                return "operator";
            }
            if ((e.eatWhile(T), x)) for (; e.match(x);) e.eatWhile(T);
            var o = e.current();
            return R(f, o)
                ? (R(h, o) && (i = "newstatement"), R(y, o) && (s = !0), "keyword")
                : R(p, o)
                    ? "type"
                    : R(m, o) || (C && C(o))
                        ? (R(h, o) && (i = "newstatement"), "builtin")
                        : R(g, o)
                            ? "atom"
                            : "variable";
        }
        ...
        function M(e, t) {
            l.typeFirstDefinitions &&
                e.eol() &&
                F(t.context) &&
                (t.typeAtEndOfLine = z(e, t, e.pos));
        }
        return {
            startState: function (e) {
                return {
                    tokenize: null,
                    context: new D((e || 0) - c, 0, "top", null, !1),
                    indented: 0,
                    startOfLine: !0,
                    prevToken: null,
                };
            ...
            token: function (e, t) {
                ...
                if (
                    ...
                    for (; "statement" == t.context.type;) E(t);
                else if ("{" == i) P(t, e.column(), "}");
                else if ("[" == i) P(t, e.column(), "]");
                else if ("(" == i) P(t, e.column(), ")");
                else if ("}" == i) {
                    for (; "statement" == n.type;) n = E(t);
                    for ("}" == n.type && (n = E(t)); "statement" == n.type;) n = E(t);
                } else
                    i == n.type
                        ? E(t)
                        : a &&
                        ...
                        P(t, e.column(), "statement", e.current());
                if (
                    ("variable" == r &&
                        ("def" == t.prevToken ||
                            (l.typeFirstDefinitions &&
                ...
                return (
                    "def" == r && !1 === l.styleDefs && (r = "variable"),
                    (t.startOfLine = !1),
                    (t.prevToken = s ? "def" : r || i),
                    M(e, t),
                    r
                );
            },
            indent: function (e, t) {
                if ((e.tokenize != I && null != e.tokenize) || e.typeAtEndOfLine)
                    return L.Pass;
                var n = e.context,
                    r = t && t.charAt(0),
                    o = r == n.type;
                if (
                    ...
                    for (; "statement" == n.type && l.dontIndentStatements.test(n.info);)
                        n = n.prev;
                if (k.indent) {
                    var a = k.indent(e, n, t, c);
                    if ("number" == typeof a) return a;
                }
                var i = n.prev && "switch" == n.prev.info;
    ...
    function b(e, t) {
        ...
        r(t.keywords),
            ...
            r(t.atoms),
            n.length &&
            ((t.helperType = e[0]), L.registerHelper("hintWords", e[0], n));
        for (var o = 0; o < e.length; ++o) L.defineMIME(e[o], t);
    }
    function x(e, t) {
        for (var n = !1; !e.eol();) {
            if (!n && e.match('"""')) {
